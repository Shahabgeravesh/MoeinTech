        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white p-8 md:p-10 rounded-2xl shadow-xl border border-gray-100">
              <ul className="text-lg md:text-xl text-gray-700 leading-relaxed list-disc list-inside space-y-3 max-w-2xl mx-auto text-start">
                <li>{t('why.item1')}</li>
                <li>{t('why.item2')}</li>
                <li>{t('why.item3')}</li>
                <li>{t('why.item4')}</li>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 mb-10 md:mb-12">
              ...
              <div className="text-center md:text-start">
                ...
                <p className="mt-2 flex items-center justify-center md:justify-start gap-1.5 text-sm text-gray-500">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 text-blue-500 shrink-0" aria-hidden>
